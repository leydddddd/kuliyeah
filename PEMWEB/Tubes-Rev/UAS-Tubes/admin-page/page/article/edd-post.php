...
$stmt = mysqli_prepare($connect, "SELECT * FROM news WHERE id = ?");
        ...
        <div class="container mt-5 bg-light p-5 rounded shadow-lg">
            ...
            <form action="processEditPost.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="content" name="content" value="<?php echo $content ?>" rows="5" required></textarea>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-outline-secondary mt-2">Edit Postingan</button>
            </form>
        </div>
    </section>
</body>
