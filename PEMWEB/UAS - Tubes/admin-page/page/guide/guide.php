        ...
        <div class=" container pt-3 pb-3">
            <div class="row">
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <img src="../uploads/<?= htmlspecialchars($data['image']) ?>" class="content-image img-fluid rounded-3 mb-3" style="height: 280px; width: min-content;" />
                </div>
                <div class="col-md-6">
                    <p class="lead text-break-word text-justify" style="text-align: justify;"><?= htmlspecialchars($data['content']) ?></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="lead text-break-word text-justify" style="text-align: justify;">
                        <?= htmlspecialchars($data['content2']) ?>
                    </p>
                </div>
