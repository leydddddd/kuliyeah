...
void mesin_slot(Wallet *wallet)
{
    ...
    for (int i = 0; i < rounds; ++i)
    {
        ...
        wallet->coins += total - bet;

        cout << "Ronde " << (i + 1) << ": " << reels[0] << " " << reels[1] << " " << reels[2] << " | Menang: " << total << " coins" << endl;
        cout << endl;
    }
...
void rules()
{
    ...
    cout << "Tiga simbol 'L'          : 1.5x multiplier" << endl;
    cout << "Tiga simbol 'W'          : 5x multiplier" << endl;
    cout << "Tiga simbol '7'          : 10x multiplier (Jackpot)" << endl;
    cout << "Dua simbol 'W' and 'L'   : Bet awal dikembalikan + bonus 50%" << endl;
