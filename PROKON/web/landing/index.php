                        ...
                        <div class="card-body" id="rooms1">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="../res/lokasi1.webp" class="card-img-top rounded" alt="icon1" height="300">
                                        </div>
                                        <!-- Nama Meeting Room, Luas, Harga dan Lokasi -->
                                        <div class="col-8 d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-start">
                                                <h2 class="fw-bold">Meeting Room A</h2>
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                <p class="fs-6">
                                            ...
                                            <div class="d-flex justify-content-start mt-auto gap-3">
                                                <div class="d-flex align-items-center p-2 rounded-3" style="background:#f7f7f7;">
                                                    ...
                                                    <div class="d-flex flex-column lh-sm align-items-start">
                                                        ...
                                                        <span class="fw-bold text-warning fs-6">Rp62.000/Jam</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center p-2 rounded-3" style="background:#f7f7f7;">
                                                    <div class="me-2">
                                                    ...
                                                    <div class="d-flex flex-column lh-sm align-items-start">
                                                        ...
                                                        <span class="fw-bold text-warning fs-6">6 Pax</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center p-2 rounded-3" style="background:#f7f7f7;">
                                                    <div class="me-2">
                                                    ...
                                                    <div class="d-flex flex-column lh-sm align-items-start">
                                                        ...
                                                        <span class="fw-bold text-warning fs-6">24 m<sup>2</sup></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex flex-row mb-3">
                                        ...
                                        <div class="d-flex flex-column mb-2 justify-content-start">
                                            <label for="tanggal" class="form-label fw-bold fs-6 text-start">Pilih Tanggal:</label>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-3">
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">08:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">09:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">10:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">11:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">12:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">13:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">14:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">15:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">16:00</button>
                                        </div>
                                        <div class="d-flex flex-column justify-content-start">
                                            <button type="button" class="time-btn btn btn-outline-dark me-2 fs-6 px-5">17:00</button>
                                        </div>
                                    </div>
                                    <!-- Button Booking dan Total Harga-->
                                    <div class="d-flex align-items-center p-2 rounded-3 mt-3" style="background:#f7f7f7;">
                                        <div class="d-flex flex-column lh-sm align-items-start">
                                            ...
                                            <span class="fw-bold text-warning fs-6">Total Harga : Rp186.000</span>
                                        </div>
                                        <div class="d-flex ms-auto">
                                            <button class="btn btn-primary rounded-3 fs-6 px-5">
                                                Booking Sekarang
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="../res/lokasi2.webp" class="card-img-top rounded" alt="icon1" height="300">
                                        </div>
                                        <!-- Nama Meeting Room, Luas, Harga dan Lokasi -->
                                        <div class="col-8 d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-start">
                                                <h2 class="fw-bold">Meeting Room B</h2>
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                <p class="fs-6">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-geo-fill" viewBox="0 0 16 16">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <img src="../res/lokasi3.webp" class="card-img-top rounded" alt="icon1" height="300">
                                        </div>
                                        <!-- Nama Meeting Room, Luas, Harga dan Lokasi -->
                                        <div class="col-8 d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-start">
                                                <h2 class="fw-bold">Meeting Room C</h2>
                                            </div>
                                            <div class="d-flex justify-content-start">
                                                <p class="fs-6">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-geo-fill" viewBox="0 0 16 16">
                                            ...
                                            <!-- Bottom Content -->
                                            <div class="d-flex justify-content-start mt-auto gap-3">
                                                <div class="d-flex align-items-center p-2 rounded-3 px-4" style="background:#f7f7f7;">
                                                    <div class="me-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-tags" viewBox="0 0 16 16">
                                                            <path d="M3 2v4.586l7 7L14.586 9l-7-7zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586z" />
                                                            <path d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1z" />
